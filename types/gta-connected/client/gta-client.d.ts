...
import Resource = GTA_Client.Resource;
import EventName = GTA_Client.EventName;

export namespace GTA_Client {
    export type EventName =
        GTA_III_Client_Event_Names.EventName
        | GTA_VC_Client_Event_Names.EventName
        | GTA_SA_Client_Event_Names.EventName
        | GTA_IV_Client_Event_Names.EventName
    export interface Resource extends Shared.Resource  {
        isReady: () => boolean
    }

    export type Element =
        GTA_III_Client_Element.Element
        | GTA_VC_Client_Element.Element
        | GTA_SA_Client_Element.Element
        | GTA_IV_Client_Element.Element
    export type Entity =
        GTA_III_Client_Element.Entity
        | GTA_VC_Client_Element.Entity
        | GTA_SA_Client_Element.Entity
        | GTA_IV_Client_Element.Entity
    export type Blip =
        GTA_III_Client_Element.Blip
        | GTA_VC_Client_Element.Blip
        | GTA_SA_Client_Element.Blip
        | GTA_IV_Client_Element.Blip
    export type Building =
        GTA_III_Client_Element.Building
        | GTA_VC_Client_Element.Building
        | GTA_SA_Client_Element.Building
        | GTA_IV_Client_Element.Building
    export type Physical =
        GTA_III_Client_Element.Physical
        | GTA_VC_Client_Element.Physical
        | GTA_SA_Client_Element.Physical
        | GTA_IV_Client_Element.Physical
    export type _Object =
        GTA_III_Client_Element._Object
        | GTA_VC_Client_Element._Object
        | GTA_SA_Client_Element._Object
        | GTA_IV_Client_Element._Object
    export type Pickup =
        GTA_III_Client_Element.Pickup
        | GTA_VC_Client_Element.Pickup
        | GTA_SA_Client_Element.Pickup
        | GTA_IV_Client_Element.Pickup
    export type PickupType = GtaConnectedLibraryTypes.PickupType;
    export type Marker =
        GTA_III_Client_Element.Marker
        | GTA_VC_Client_Element.Marker
        | GTA_SA_Client_Element.Marker
        | GTA_IV_Client_Element.Marker
}
 ...
 */
export function triggerNetworkEvent(networkEventName: NetworkEventName, ...args: any[]): void
...
/**
 * The setChatWindowEnabled function is used to set the visible state of the chat window.
 * @param enabled Whether the chat window is visible.
 * @see https://wiki.gtaconnected.com/setChatWindowEnabled
 */
export function setChatWindowEnabled(enabled: boolean): void

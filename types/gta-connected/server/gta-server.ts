...
import {Client, EventHandler, NetworkEventName} from "../index";
...
export namespace GTA_Server {
    export type EventName = GTA_III_Server_Event_Names.EventName | GTA_VC_Server_Event_Names.EventName | GTA_SA_Server_Event_Names.EventName | GTA_IV_Server_Event_Names.EventName
    export type Resource = Shared.Resource
    export type Element = GTA_III_Server_Element.Element | GTA_VC_Server_Element.Element | GTA_SA_Server_Element.Element | GTA_IV_Server_Element.Element
    export type Entity = GTA_III_Server_Element.Entity | GTA_VC_Server_Element.Entity | GTA_SA_Server_Element.Entity | GTA_IV_Server_Element.Entity
    export type Blip = GTA_III_Server_Element.Blip | GTA_VC_Server_Element.Blip | GTA_SA_Server_Element.Blip | GTA_IV_Server_Element.Blip
    export type Building = GTA_III_Server_Element.Building | GTA_VC_Server_Element.Building | GTA_SA_Server_Element.Building | GTA_IV_Server_Element.Building
    export type Physical = GTA_III_Server_Element.Physical | GTA_VC_Server_Element.Physical | GTA_SA_Server_Element.Physical | GTA_IV_Server_Element.Physical
    export type _Object = GTA_III_Server_Element._Object | GTA_VC_Server_Element._Object | GTA_SA_Server_Element._Object | GTA_IV_Server_Element._Object
    export type Marker = GTA_III_Server_Element.Marker | GTA_VC_Server_Element.Marker | GTA_SA_Server_Element.Marker | GTA_IV_Server_Element.Marker
    export type Pickup = GTA_III_Server_Element.Pickup | GTA_VC_Server_Element.Pickup | GTA_SA_Server_Element.Pickup | GTA_IV_Server_Element.Pickup
     ...
     */
    export declare function triggerNetworkEvent(networkEventName: NetworkEventName, client?: Client, ...args: any[]): void
